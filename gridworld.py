...
def parseOptions():
    ...
    optParser.add_option('-a', '--agent',action='store', metavar="A",
                         ...
                         help='Agent type (options are \'random\', \'value\', \'policy\',\'q\', and \'learn\', default %default)')
...
if __name__ == '__main__':
    ...
    import valueIterationAgents, qlearningAgents,policyIterationAgent
    a = None
    if opts.agent == 'value':
        a = valueIterationAgents.ValueIterationAgent(mdp, opts.discount, opts.iters)
    elif opts.agent == 'policy':
        a = policyIterationAgent.PolicyIterationAgent(mdp, opts.discount, opts.iters)
    ...
    try:
        if not opts.manual and opts.agent in ('policy','value', 'asynchvalue', 'priosweepvalue', 'learn'):
            if opts.valueSteps:
